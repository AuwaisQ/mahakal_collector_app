...
import 'package:collectorapp/features/sdm/home/sdmdetails_screen.dart';
...
import 'controller/sdmdashboard_controller.dart';
import 'employeelist_screen.dart';
import 'model/sdmdashboard_model.dart';


class SDMDashboardScreen extends StatefulWidget {
  const SDMDashboardScreen({Key? key}) : super(key: key);

  @override
  State<SDMDashboardScreen> createState() =>
      _SDMDashboardScreenState();
}

class _SDMDashboardScreenState extends State<SDMDashboardScreen> {

  @override
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<SDMDashboardController>().fetchSDMDashboard();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<SDMDashboardController>(
        builder: (BuildContext context, sdmController, Widget? child) {
          if (sdmController.isLoading) {
            return Center(
              child: CircularProgressIndicator(color: Colors.orange),
            );
          }

          final data = sdmController.SDMDashModel;

          if (data == null || data.sdmDetail!.templesDetail.isEmpty) {
            return const EmptyState(
              message: "No sdm data found!",
                  ...
                  flexibleSpace: LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      return FlexibleSpaceBar(
                        ...
                        title: isCollapsed
                            ? Text(
                          "${sdmController.SDMDashModel?.sdmDetail?.name.split(' ').first ?? 'Collector'}",
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 20,
                        ...
                        background: Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                // Top bar with logout and notification
                                          ...
                                          child: RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                  "${sdmController.SDMDashModel?.sdmDetail?.name ?? 'SDM'}",
                                                  style: TextStyle(
                                                    color: Colors.white,
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    "${sdmController.SDMDashModel?.sdmDetail?.email ?? 'N/A'}",
                                                    style: TextStyle(
                                                      color: Colors.white,
                                                      fontSize: 15,
                ...
                SliverPadding(
                  ...
                  sliver: SliverGrid(
                    delegate: SliverChildBuilderDelegate((context, index) {
                      final mandirList =
                      sdmController.filteredTemples[index];
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => SDMDetailsScreen(
                    ...
                    }, childCount: sdmController.filteredTemples.length),
  ...
  // Mandir Card Widget
  Widget _mandirCard(SDMTemplesDetail mandir) {
    return AnimatedContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          //     ),
          //
          //     // Mandir Name on Image (more premium)
          //     Positioned(
          //       left: 10,
          //       bottom: 8,
          //       right: 10,
...
class _StatsHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(
    ...
    return Container(
      ...
      child: Consumer<SDMDashboardController>(
        builder: (BuildContext context, sdmDashboardController, child) {
          return Column(
            children: [
              Row(
                children: [
                  Expanded(
                    child: _buildStatCard(
                      ...
                      Icons.people,
                      "Visitors Today",
                      "${sdmDashboardController.SDMDashModel?.sdmDetail?.totalUser}",
                  ...
                  Expanded(
                    child: _buildStatCard(
                      ...
                      Icons.temple_hindu,
                      "Total Mandirs",
                      "${sdmDashboardController.SDMDashModel?.sdmDetail?.totalTemple}",
                      isScrolled: isScrolled,
                    ),
                  ),
                  SizedBox(width: 12),
                  Expanded(
                    child: _buildStatCard(
                      ...
                      "Total Amount",
                      "${sdmDashboardController.SDMDashModel?.sdmDetail?.totalAmount}",
                      isScrolled: isScrolled,
                      isAmount: true
                    ),
                  ),
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  if (sdmDashboardController.SDMDashModel?.sdmDetail?.totalEmployee != null)
                                  Padding(
                                    padding: const EdgeInsets.only(top: 4),
                                    child: Text(
                                      "${sdmDashboardController.SDMDashModel?.sdmDetail?.totalEmployee} SDMs assigned",
                                      style: TextStyle(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: TextField(
                        onChanged: (value) {
                          sdmDashboardController.upDateSearchQuery(value);
                        },
