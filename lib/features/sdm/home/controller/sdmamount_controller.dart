...
class SDMAmountFilterController extends ChangeNotifier{
  bool _isLoading = false;
  bool get isLoading => _isLoading;

  SdmAmountFilterModel? _amountFilterModel;
  SdmAmountFilterModel? get amountFilterModel => _amountFilterModel;
  ...
  Future<void> fetchAmountFilter({
    ...
    try {
      ...
      final apiUrl = '${AppConstants.sdmAmountFilterAPI}'
      ...
      if(res != null){
        _amountFilterModel = SdmAmountFilterModel.fromJson(res);
      }
    } catch (e, stackTrace) {
