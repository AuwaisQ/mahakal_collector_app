...
import 'controller/collectoramountfilter_controller.dart';
import 'controller/collectordetails_controller.dart';
...
class CollectorDetailsScreen extends StatefulWidget {
  ...
  CollectorDetailsScreen({required this.mandirId});
...
class _CollectorDetailsScreenState extends State<CollectorDetailsScreen> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<CollectorDetailsController>().fetchCollectorDetails(
        widget.mandirId,
      );
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CollectorDetailsController>(
        builder: (BuildContext context, collectorDetailsController, Widget? child) {
          if (collectorDetailsController.isLoading) {
            return Center(
    ...
    return AppBar(
      ...
      flexibleSpace: Container(
        decoration: const BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [Color(0xFFFF6B35), Color(0xFFFF8C42), Color(0xFFFFA62E)],
...
class AmountCardsWithFilter extends StatefulWidget {
  final CollectorDetailsModel data;
...
class _AmountCardsWithFilterState extends State<AmountCardsWithFilter> {
  ...
  void _applyFilter(BuildContext context) {
    ...
    final filterController = context.read<CollectorAmountFilterController>();
  ...
  void _clearFilter() {
    ...
    context.read<CollectorAmountFilterController>().clearFilter();
  }

  // Helper methods to get display data
  dynamic _getDisplayData(CollectorAmountFilterController filterController) {
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer<CollectorAmountFilterController>(
  ...
  Widget _buildFilterHeader(CollectorAmountFilterController filterController) {
    return Container(
...
// class AmountCardsWithFilter extends StatefulWidget {
//   final CollectorDetailsModel data; // Your collector details data
//
//   const AmountCardsWithFilter({Key? key, required this.data}) : super(key: key);
//
//   @override
