...
//
//   Future<void> fetchCollectorTempleList(String collectId, String sdmId) async {
//     _setLoading(true);
//
//     print("Collector Id $collectId");
//     print("SDM Id $sdmId");
//
//     Map<String, dynamic> body = {
//       "collector_id": collectId,
//       "sdm_id": sdmId
//     };
//
//     try{
//       final res = await HttpService().postApi("${AppConstants.collectorTempleListAPI}",body);
//       print("Collector Temple List $res");
//
//       if(res !=null){
//         _collectorTempleListModel = CollectorTempleListModel.fromJson(res);
//         _filterCollectorTempleList = _collectorTempleListModel!.templeList;
//       }
//     }catch (e, stackTrace) {
...
//     _searchQuery = query;
//
//     if (_collectorTempleListModel?.templeList != null) {
//       if (query.isEmpty) {
//         _filterCollectorTempleList = _collectorTempleListModel?.templeList ?? [];
//       } else {
//         _filterCollectorTempleList = _collectorTempleListModel!.templeList
...
//
//   final List<String> _availableFilters = ['All', 'Open Now', 'Morning', 'Evening'];
...
//       if(res !=null){
//         _collectorTempleListModel = CollectorTempleListModel.fromJson(res);
//         _originalTempleList = _collectorTempleListModel!.templeList;
...
//     try {
//       final openingTime = temple.openingTime ?? '05:00:00';
//       final time = DateFormat('HH:mm:ss').parse(openingTime);
...
//   }
//
//   // Get opening time as TimeOfDay
//   TimeOfDay? getOpeningTime(TempleList temple) {
//     try {
//       final openingTime = temple.openingTime ?? '05:00:00';
//       final time = DateFormat('HH:mm:ss').parse(openingTime);
...
//   }
//
//   // Get closing time as TimeOfDay
//   TimeOfDay? getClosingTime(TempleList temple) {
//     try {
//       final closingTime = temple.closeingTime ?? '19:00:00';
//       final time = DateFormat('HH:mm:ss').parse(closingTime);
//       return TimeOfDay.fromDateTime(time);
//     } catch (e) {
//       return null;
//     }
